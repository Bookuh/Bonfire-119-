...
1.  Do 5 CodeWars problems in R. Share your solutions here:
  ...
  return (sum /length(vec))
    ...
    #2. Find the sum of all multiples of n below m
  ...
  return(sum(seq(from = n, to = (m - 1), by = n)))
    ...
    #4. There's a waiting room with N chairs set in single row. Chairs are consecutively numbered from 1 to N. First is closest to the entrance (which is exit as well).
    ...
    last_chair <- function(n) {
      n - 1
    }
    #5. A hero is on his way to the castle to complete his mission. However, he's been told that the castle is surrounded with a couple of powerful dragons! each dragon takes 2 bullets to     be defeated, our hero has no idea how many bullets he should carry.. Assuming he's gonna grab a specific given number of bullets and move forward to fight another specific given          number of dragons, will he survive?
...
```{r}
data("mtcars")
# Discrete: cyl, vs, am, gear,
# Continuous: mpg, disp, hp, drat, wr, qsec,  carn
```
...
ggplot(mtcars, aes(x = factor(cyl))) +
  ...
  ggtitle("Bar Plot: Number of Cylinders")

# Mutate 'wt' column: weight in kilograms instead of pounds
mtcars <- mutate(mtcars, wt_kg = wt * 0.453592)

# Mutate 'disp' column: engine displacement in liters instead of cubic inches
mtcars <- mutate(mtcars, disp_liters = disp * 0.0163871)
